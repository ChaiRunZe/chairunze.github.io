...
function SolarTerm(DateGL){
    ...
    var JQ;
    if(DateGL.getDate()==BeginTime.getDate()){
        JQ="　 今天是<span color='#FF9999'><b>"+SolarTermStr[M] + "</b></span>";
    }
    else if(DateGL.getDate()==BeginTime.getDate()-1){
        JQ="　 明天是<span color='#FF9999'><b>"+SolarTermStr[M] + "</b></span>";
    }
    else if(DateGL.getDate()==BeginTime.getDate()-2){
        JQ="　 后天是<span color='#FF9999'><b>"+SolarTermStr[M] + "</b></span>";
    }
    else{
        JQ=" ";
