...
(function (name, definition) {
    var hasDefine = typeof define === 'function', hasExports = typeof module !== 'undefined' && module.exports;
    if (hasDefine) {
        define(definition);
    } else if (hasExports) {
    ...
    MeScroll.prototype.extendUpScroll = function (optUp) {
        ...
        MeScroll.extend(optUp, {
            ...
            onScroll: null,
            scrollbar: {use: isPC, barClass: "mescroll-bar"}
        })
    };
    ...
    MeScroll.prototype.endSuccess = function (dataSize, systime) {
        ...
        if (this.optUp.use) {
            ...
            if (pageNum == 1)this.clearDataList();
            var isShowNoMore;
            if (dataSize != null) {
    ...
    MeScroll.prototype.showEmpty = function () {
        ...
        if (emptyWarp) {
            me.removeEmpty();
            var str = '';
            if (optEmpty.icon)str += '<img class="empty-icon" src="' + optEmpty.icon + '"/>';
            if (optEmpty.tip)str += '<p class="empty-tip">' + optEmpty.tip + '</p>';
            if (optEmpty.btntext)str += '<p class="empty-btn">' + optEmpty.btntext + '</p>';
